...
public class WorldFactory {
    ...
    public static Entity createWorld(PooledEngine engine){
        ...
        DimensionComponent rc = new DimensionComponent(100,100);//(Constants.GAME_WORLD_WIDTH, Constants.GAME_WORLD_HEIGHT); //update to actual size
        TextureComponent txc = new TextureComponent();
        MapComponent mc = new MapComponent();
        TransformComponent tc = new TransformComponent(100,100);
